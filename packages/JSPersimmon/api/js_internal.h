...
int js_lcd_init(jerry_value_t obj);
...
int js_ota_init(jerry_value_t obj);
int js_animation_init(jerry_value_t obj);

int js_timeout_init(void);

int js_player_init(jerry_value_t obj);
int js_player_deinit(void);
